...
### Steps to Run
1. Initialize the SQLite database and load the model binaries:
   ```bash
   python app.py
   ```
2. Open your web browser and navigate to:
   **[http://127.0.0.1:5000](http://127.0.0.1:5000)**
3. Adjust the **Sensitivity Slider**, type or dictate comments, or drop chat screenshots into the OCR panel to monitor safety logs in real time.
